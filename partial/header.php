              ...
              <ul class="nav navbar-nav">
                    ...
                    if ($show_catagory) {
                        while ($row = mysqli_fetch_assoc($show_catagory)) {
                            ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $row['catName']; ?>
            ...
            if ($show_catagory) {
                while ($row = mysqli_fetch_assoc($show_catagory)) {
                    ...
                    <li class="list-item-mobile">
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle" data-toggle="dropdown"><?php echo $row['catName']; ?></button>
                            <ul class="dropdown-menu">
